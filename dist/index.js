...
const dns_record_management_1 = __nccwpck_require__(2168);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        const changeInfo = yield dns_record_management_1.deleteDnsRecords({
            hostedZoneId: core_1.getInput("hosted-zone-id"),
            records: core_1.getInput("records"),
            comment: core_1.getInput("comment"),
        });
        if (!changeInfo)
            throw new Error("Failed to apply changes");
        core_1.info("Change Info:");
        core_1.info(`  Id: ${changeInfo.Id}`);
        core_1.info(`  Status: ${changeInfo.Status}`);
        core_1.info(`  Submitted At: ${changeInfo.SubmittedAt}`);
        core_1.info(`  Comment: ${changeInfo.Comment}`);
        return 0;
    });
}
exports.run = run;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.deleteDnsRecords = void 0;
const fs = __importStar(__nccwpck_require__(5747));
const yaml_1 = __nccwpck_require__(3552);
const route53_1 = __importDefault(__nccwpck_require__(4968));
function getClient() {
    return new route53_1.default({
...
function generateDeletions(recordInput) {
    const records = processData(recordInput);
    return records.map((record) => {
        return { Action: "DELETE", ResourceRecordSet: record };
    });
}
function deleteDnsRecords(inputs) {
    return __awaiter(this, void 0, void 0, function* () {
        const { hostedZoneId, records, comment } = inputs;
        const changes = generateDeletions(records);
        const { ChangeInfo } = yield getClient()
...
exports.deleteDnsRecords = deleteDnsRecords;
//# sourceMappingURL=dns-record-management.js.map
...
__exportStar(__nccwpck_require__(2168), exports);
...
__nccwpck_require__(9627);
Object.defineProperty(apiLoader.services['route53'], '2013-04-01', {
  get: function get() {
    var model = __nccwpck_require__(1499);
    model.paginators = __nccwpck_require__(4519)/* .pagination */ .o;
    model.waiters = __nccwpck_require__(4628)/* .waiters */ .V;
    return model;
  },
  enumerable: true,
  configurable: true
...
"use strict";
module.exports = JSON.parse('{"o":{"ListHealthChecks":{"input_token":"Marker","limit_key":"MaxItems","more_results":"IsTruncated","output_token":"NextMarker","result_key":"HealthChecks"},"ListHostedZones":{"input_token":"Marker","limit_key":"MaxItems","more_results":"IsTruncated","output_token":"NextMarker","result_key":"HostedZones"},"ListQueryLoggingConfigs":{"input_token":"NextToken","limit_key":"MaxResults","output_token":"NextToken","result_key":"QueryLoggingConfigs"},"ListResourceRecordSets":{"input_token":["StartRecordName","StartRecordType","StartRecordIdentifier"],"limit_key":"MaxItems","more_results":"IsTruncated","output_token":["NextRecordName","NextRecordType","NextRecordIdentifier"],"result_key":"ResourceRecordSets"}}}');
